...
from nets.mobilenet import prunable_conv_blocks as ops
from nets.mobilenet import prunable_mobilenet as lib

from tensorflow.contrib.model_pruning import masked_conv2d # by LDY
from tensorflow.contrib.model_pruning import masked_fully_connected # by LDY
...
#        (slim.conv2d, slim.fully_connected, slim.separable_conv2d): {
        (masked_conv2d, masked_fully_connected, slim.separable_conv2d): { # by LDY
...
#        (slim.conv2d, slim.separable_conv2d): {'padding': 'SAME'}
        (masked_conv2d, slim.separable_conv2d): {'padding': 'SAME'} # by LDY
    },
    spec=[
#        op(slim.conv2d, stride=2, num_outputs=32, kernel_size=[3, 3]),
        op(masked_conv2d, stride=2, num_outputs=32, kernel_size=[3, 3]), # by LDY
...
#        op(slim.conv2d, stride=1, kernel_size=[1, 1], num_outputs=1280)
        op(masked_conv2d, stride=1, kernel_size=[1, 1], num_outputs=1280) # by LDY
    ],
)
# pyformat: enable
...
#        defaults[(slim.conv2d, slim.fully_connected, slim.separable_conv2d)])
        defaults[(masked_conv2d, masked_fully_connected, slim.separable_conv2d)]) # by LDY
