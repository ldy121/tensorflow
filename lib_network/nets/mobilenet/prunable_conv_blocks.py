...
#    return slim.conv2d(input_tensor, num_outputs, [1, 1], scope=scope, **kwargs)
    return masked_conv2d(input_tensor, num_outputs, [1, 1], scope=scope, **kwargs) # by LDY
...
#    n = slim.conv2d(input_tensor, out_size, [1, 1], scope=scope, **kwargs)
    n = masked_conv2d(input_tensor, out_size, [1, 1], scope=scope, **kwargs) # by LDY
