...
#        intermediate_layer = slim.conv2d(
        intermediate_layer = masked_conv2d( # by LDY
            pre_layer,
...
#        feature_map = slim.conv2d(
        feature_map = masked_conv2d( # by LDY
            feature_map,
...
#        [slim.conv2d, slim.separable_conv2d], padding=padding, stride=1):
        [masked_conv2d, slim.separable_conv2d], padding=padding, stride=1): # by LDY
#      top_down = slim.conv2d(
      top_down = masked_conv2d( # by LDY
          image_features[-1][1],
...
#    image_features = slim.conv2d(
    image_features = masked_conv2d( # by LDY
        image_features,
...
#    with slim.arg_scope([slim.conv2d], padding='SAME', stride=2):
    with slim.arg_scope([masked_conv2d], padding='SAME', stride=2): # by LDY
