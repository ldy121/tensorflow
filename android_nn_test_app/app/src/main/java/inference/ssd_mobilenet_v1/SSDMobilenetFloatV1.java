...
public class SSDMobilenetFloatV1 extends Inference {
    ...
    protected String getModelPath() {
        return "ssd_mobilenet_v1_1.tflite"; // by LDY
    }
    ...
    @Override
    public String name() {
        return String.format("SSD MobilenetV1 Float Model (Batch %d)", getBatchSize());
    }
    ...
    public Inference clone() {
        return new SSDMobilenetFloatV1();
    }
}
