...
public class Float16InferenceFactory extends InferenceFactory {
    private static Float16InferenceFactory instance = new Float16InferenceFactory();

    private Float16InferenceFactory() {
