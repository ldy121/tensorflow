...
public final class Interpreter implements AutoCloseable {
  ...
  public static class Options {
    ...
    public Options setAccelerator(String accelerator) { // by LDY
      if (accelerator != null) {
        this.m_accelerator = new String(accelerator);
      } else {
    ...
    public Options setOperationMode(String operation_mode) { // by LDY
      if (operation_mode != null) {
        this.m_operation = new String(operation_mode);
      } else {
    ...
    String m_accelerator = null; // by LDY
    String m_operation = null; // by LDY
    int numThreads = -1;
    Boolean useNNAPI;
  ...
  public long get_driver_time() { // by LDY
    if (wrapper != null) {
      return wrapper.get_driver_time();
    } else {
      return -1;
    }
  }
