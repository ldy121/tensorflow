...
class StatefulNnApiDelegate : public TfLiteDelegate {
 ...
 private:
  ...
  long long m_hw_exe_time;     // by LDY
  long long m_driver_exe_time; // by LDY
  ObserverDelegate * m_observer;

  public :
  // by LDY
  std::vector<std::string*> * getDeviceNames();
  long long get_driver_exe_time() {
    return m_driver_exe_time;
  }
  long long get_hw_exe_time() {
    return m_hw_exe_time;
  }
  void set_hw_exe_time(long long hw_exe_time) {
    m_hw_exe_time = hw_exe_time;
  }
  void set_driver_exe_time(long long driver_exe_time) {
    m_driver_exe_time = driver_exe_time;
  }

  ObserverDelegate * get_observer() {
    return m_observer;
  }
};
...
class ObserverDelegate { // by LDY
  private :
    StatefulNnApiDelegate * m_delegate;    
  public :
    ObserverDelegate(StatefulNnApiDelegate * delegate) : m_delegate(delegate){};
    void update(long long hw_exe_time, long long driver_exe_time) {
      m_delegate->set_hw_exe_time(hw_exe_time);
      m_delegate->set_driver_exe_time(driver_exe_time);
    }
};
...
TfLiteDelegate* NnApiDelegate(StatefulNnApiDelegate::Options option);
